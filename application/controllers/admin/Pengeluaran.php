...
class Pengeluaran extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('level') == 'Administrator') {
            $this->load->view('admin/pengeluaran/v_data', $data);
        } else {
    ...
    public function add()
    {
        ...
        $this->load->view('templates/main/sidebar', $data);
        if ($this->session->userdata('level') == 'Administrator') {
            $this->load->view('admin/pengeluaran/v_add', $data);
        } else {
            $this->load->view('other/forbiden');
        }
        $this->load->view('templates/main/footer');
    ...
    public function edit($id_pengeluaran)
    {
        ...
        $this->load->view('templates/main/sidebar', $data);
        if ($this->session->userdata('level') == 'Administrator') {
            $this->load->view('admin/pengeluaran/v_edit', $data);
        } else {
            $this->load->view('other/forbiden');
        }
        $this->load->view('templates/main/footer');
    ...
    public function detail($id_pengeluaran)
    {
        ...
        $this->load->view('templates/main/sidebar', $data);
        if ($this->session->userdata('level') == 'Administrator') {
            $this->load->view('admin/pengeluaran/v_detail', $data);
        } else {
            $this->load->view('other/forbiden');
        }
        $this->load->view('templates/main/footer');
