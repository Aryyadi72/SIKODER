...
class Pemasukan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('level') == 'Admin Lapangan') {
            $this->load->view('admin_lapangan/pemasukan/v_data', $data);
        } else {
    ...
    public function add()
    {
        ...
        $this->load->view('templates/main/sidebar', $data);
        if ($this->session->userdata('level') == 'Admin Lapangan') {
            $this->load->view('admin_lapangan/pemasukan/v_add', $data);
        } else {
            $this->load->view('other/forbiden');
        }
        $this->load->view('templates/main/footer');
    ...
    public function insert()
    {
        ...
        redirect('admin_lapangan/pemasukan');
    }
    ...
    public function edit($id_pemasukan)
    {
        ...
        $this->load->view('templates/main/sidebar', $data);
        if ($this->session->userdata('level') == 'Admin Lapangan') {
            $this->load->view('admin_lapangan/pemasukan/v_edit', $data);
        } else {
            $this->load->view('other/forbiden');
        }
        $this->load->view('templates/main/footer');
