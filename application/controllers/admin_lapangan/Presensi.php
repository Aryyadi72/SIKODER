...
class Presensi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('level') == 'Admin Lapangan') {
            $this->load->view('admin_lapangan/presensi/v_data', $data);
        } else {
    ...
    public function history()
    {
        ...
        $this->load->view('templates/main/sidebar', $data);
        if ($this->session->userdata('level') == 'Admin Lapangan') {
            $this->load->view('admin_lapangan/presensi/v_history', $data);
        } else {
            $this->load->view('other/forbiden');
        }
        $this->load->view('templates/main/footer');
    ...
    //     $this->load->view('templates/main/sidebar', $data);
    //     if ($this->session->userdata('level') == 'Admin Lapangan') {
    //         $this->load->view('admin_lapangan/presensi/v_edit', $data);
    //     } else {
    //         $this->load->view('other/forbiden');
    //     }
    //     $this->load->view('templates/main/footer');
