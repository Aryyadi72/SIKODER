...
<a href="<?= base_url('admin_lapangan/pemasukan/add/'); ?>" class="btn btn-success mb-3">
                ...
                foreach ($pems as $row) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <?= anchor('admin_lapangan/pemasukan/edit/' . $row->id_pemasukan, '<div class="btn btn-primary"><i class="fas fa-tools"></i> Edit</div>'); ?>
                        </td>
                        <td class="text-center">
                            <a onclick="return confirm('Yakin ingin menghapus data ini?')" href="<?= base_url('admin_lapangan/pemasukan/delete/' . $row->id_pemasukan) ?>" class="btn btn-danger btn-circle"><i class="fa fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
