...
<a href="<?= base_url('admin_lapangan/presensi/'); ?>" class="btn btn-warning mb-3">
                ...
                foreach ($pres as $row) : ?>
                    <tr>
                        ...
                        <!-- <td class="text-center">
                            <a href="<?= base_url('admin_lapangan/presensi/delete/' . $row->id_presensi); ?>" onclick="return confirm('Yakin ingin membatalkan presensi?')" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                        </td> -->
                    </tr>
                <?php endforeach; ?>
            </tbody>
