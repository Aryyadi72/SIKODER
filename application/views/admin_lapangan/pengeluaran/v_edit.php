...
<a href="<?= base_url('admin_lapangan/pengeluaran/'); ?>" class="btn btn-warning mb-3">
...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <div class="card-body">
        <form action="<?= base_url('admin_lapangan/pengeluaran/update/'); ?>" method="POST" enctype="multipart/form-data">
