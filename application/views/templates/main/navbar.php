...
<nav class="main-header navbar navbar-expand navbar-primary">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a style="color:white;" href="<?= base_url('dashboard'); ?>" class="nav-link"><i class="fas fa-home"></i> Home</a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a style="color:white;" onclick="return confirm('Anda yakin mau logout?')" href="<?= base_url('auth/logout/') ?>" class="nav-link">
