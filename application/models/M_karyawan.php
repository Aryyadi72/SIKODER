...
{
    // Method yang digunakan untuk query builder select all from table karyawan
    ...
    // Method yang digunakan untuk insert data ke tabel karyawan
    ...
    // Method ini digunakan untuk memperbarui data menggunakan query builder
    public function updatex($where, $datax, $table)
    {
        $this->db->where($where);
